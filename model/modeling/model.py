...
class Model(torch.nn.Module):
    def __init__(self, vision_type='resnet_v2', bert_type='./Bio_ClinicalBERT', vision_pretrained=True,
    ...
    def fit(self, datalaoders, epochs=30, lr=5e-4, weight_decay=1e-5, scheduler=True, warmup_epoch=1, store_num=5,
        ...
        # Set scheduler
        if scheduler:
            from model.pretraining.utils import get_scheduler_per_iteration
